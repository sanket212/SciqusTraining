...
{
    public class MysqlWalkRepositorycs : IWalkRepository
    {
        private readonly NZWalksDbContext dbContext;

        public MysqlWalkRepositorycs(NZWalksDbContext dbContext)
        {
        ...
        public async Task<List<Walk>> GetAllAsync(string? filterOn = null, string filterQuery = null,
            string? shortBy = null, bool isAscending = true, int pageNumber = 1, int pageSize = 1000)
        {
